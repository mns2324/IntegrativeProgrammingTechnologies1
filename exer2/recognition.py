...
def save_machine_status(status):
    ...
    # mysql will handle the last_updated timestamp
...
stable_confidence_count = 0    # current stable frames with good confidence thresh
last_sent_fruit = ""
...
try:
    while True:
        ...
        # update machine status based on arduino's print statements
